...
uploaded_file = st.file_uploader("Upload a file:", type=["csv", "txt", "xlsx",'pdf', 'java', 'jar', 'py', 'pdf', 'docx', 'dwg', 'zip', 'mrpack', '7z', "png", 'jpg', 'h5', 'mp3', "mp4"], accept_multiple_files=True)
...
if uploaded_file is not None:
    ...
    for i in uploaded_file:
        ...
        print(f"Time was spent {fin - strt} secconds ")
